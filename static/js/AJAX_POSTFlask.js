...
// Mot cles : ajax my_XMLHttpRequest
...
//On ouvre une connexion 'XMLHttpRequest' de type POST sur le serveur 'localhost'
httpRequest.open('POST',"/ResponseJSON_AJAX_POSTFlask", true); 

var ff = JSON.stringify({id : 100, ter : 'mio', body: 'bar',userId: 1});
...
//On envoie la requete qui retourne : products[0]
